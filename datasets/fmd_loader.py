...
def load_fmd_dataset(fmd_path: str, 
                     categories: Optional[List[str]] = None) -> Tuple[List[np.ndarray], 
                                                                       np.ndarray, 
                                                                       List[np.ndarray]]:
    """
    Load FMD dataset.
...
def split_dataset_per_category(images: List[np.ndarray],
                               labels: np.ndarray,
...
def print_dataset_info(images: List[np.ndarray], 
                       labels: np.ndarray,
